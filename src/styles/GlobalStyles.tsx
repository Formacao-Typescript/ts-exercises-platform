...
const GlobalStyles = createGlobalStyle`
  ...
  * {
  ...
  .text-ts-gradient-horizontal {
    background: linear-gradient(to right, var(--trade-light-blue), var(--trade-blue));
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  }
  .text-ts-gradient-vertical {
    background: linear-gradient(to bottom, var(--trade-light-blue), var(--trade-blue));
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  }
`;
